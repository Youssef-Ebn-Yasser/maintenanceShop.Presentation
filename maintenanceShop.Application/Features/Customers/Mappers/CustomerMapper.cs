using maintenanceShop.Application.Features.Customers.Dtos;
using maintenanceShop.Domain.Customers;
using maintenanceShop.Domain.Customers.Vehicles;

namespace maintenanceShop.Application.Features.Customers.Mappers;
